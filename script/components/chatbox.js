    ...
    render(container, section) {
      ...
      div.innerHTML = `
        <div class="text-box">
          ...
          <p class="fake-btn">${section.buttonText || "Gửi"}</p>
        </div>
      `;
      // Chia tin nhắn thành các đoạn ký tự riêng lẻ để tạo hiệu ứng hoạt hình khi gõ.
      const chatbox = div.querySelector(".hbd-chatbox");
      const msg = section.message || "Chúc mừng sinh nhật!";
